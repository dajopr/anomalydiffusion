...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--mvtec_path", type=str, help="Path to mvtec")
    return parser
...
if __name__ == "__main__":
    ...
    if opt.resume:
        ...
        logdir = os.path.join(
            opt.logdir, "mask-checkpoints/%s-%s" % (opt.sample_name, opt.anomaly_name)
        )
    ...
    try:
        ...
        config.data.params.train.target = (
            "ldm.data.personalized.Personalized_mvtec_mask"
        )
